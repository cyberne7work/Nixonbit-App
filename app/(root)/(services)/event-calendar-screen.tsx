...
const mockEvents: Event[] = [
  ...
  },
  {
    ...
    description: 'An interactive workshop for book lovers with guest authors.',
  ...
  },
  {
    ...
    description: 'Monthly meeting to discuss community safety and projects.',
    contact: '206-684-4753',
  ...
  },
  {
    ...
    location: 'Remote',
    description: 'A virtual event on personal safety tips and resources.',
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const data = servicesResponse.data.events || []; // Adjust based on your API response structure
